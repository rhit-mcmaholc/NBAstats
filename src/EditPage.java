...
public class EditPage {
	...
	quantityLbl = new JTextField();
	quantityLbl.setColumns(10);
	quantityLbl.setBounds(40, 180, 126, 39);
	itemModPanel.add(quantityLbl);
	...
	quantityLbl = new JTextField();
	quantityLbl.setColumns(10);
	quantityLbl.setBounds(260, 180, 126, 39);
	itemModPanel.add(quantityLbl);
	...
	priceLbl.setBounds(260, 280, 126, 39);
	itemModPanel.add(priceLbl);
	...
	addNewLbl = new JTextField();
	addNewLbl.setColumns(10);
	addNewLbl.setBounds(40, 280, 126, 39);
	itemModPanel.add(addNewLbl);
